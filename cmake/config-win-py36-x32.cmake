...
# weird!!! when building with python36, it requires python35.lib also!!!
set(_PYTHON36_LIBRARY "${_PYTHON36_32_ROOT}/libs/python36.lib")
set(_PYTHON35_LIBRARY "${_PYTHON35_32_ROOT}/libs/python35.lib")


# set variables
set(PYTHON_INTERP python36)
set(PYTHON_ARCH 32)
set(PYTHON_INCLUDE_DIR "${_PYTHON36_32_ROOT}/include")
set(PYTHON_LIBRARIES ${_PYTHON36_LIBRARY} ${_PYTHON35_LIBRARY})
