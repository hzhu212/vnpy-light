...
with open(os.path.join(in_dir, 'ThostFtdcMdApi.h'), 'r', encoding='gbk') as fcpp,\
        open(os.path.join(out_dir, 'ctp_md_task.cpp'), 'w', encoding='utf8') as ftask,\
        open(os.path.join(out_dir, 'ctp_md_process.cpp'), 'w', encoding='utf8') as fprocess,\
        open(os.path.join(out_dir, 'ctp_md_function.cpp'), 'w', encoding='utf8') as ffunction,\
        open(os.path.join(out_dir, 'ctp_md_switch.cpp'), 'w', encoding='utf8') as fswitch,\
        open(os.path.join(out_dir, 'ctp_md_header_define.h'), 'w', encoding='utf8') as fdefine,\
        open(os.path.join(out_dir, 'ctp_md_header_process.h'), 'w', encoding='utf8') as fheaderprocess,\
        open(os.path.join(out_dir, 'ctp_md_header_on.h'), 'w', encoding='utf8') as fheaderon,\
        open(os.path.join(out_dir, 'ctp_md_header_on_orig.h'), 'w', encoding='utf8') as fheaderon_orig,\
        open(os.path.join(out_dir, 'ctp_md_header_function.h'), 'w', encoding='utf8') as fheaderfunction,\
        open(os.path.join(out_dir, 'ctp_md_wrap.cpp'), 'w', encoding='utf8') as fwrap:
