...
def processCallBack(line):
    fheaderon_orig.write(line.strip().replace('{}', '') + '\n')
...
with open(os.path.join(in_dir, 'ThostFtdcTraderApi.h'), 'r', encoding='gbk') as fcpp,\
        open(os.path.join(out_dir, 'ctp_td_task.cpp'), 'w', encoding='utf8') as ftask,\
        open(os.path.join(out_dir, 'ctp_td_process.cpp'), 'w', encoding='utf8') as fprocess,\
        open(os.path.join(out_dir, 'ctp_td_function.cpp'), 'w', encoding='utf8') as ffunction,\
        open(os.path.join(out_dir, 'ctp_td_switch.cpp'), 'w', encoding='utf8') as fswitch,\
        open(os.path.join(out_dir, 'ctp_td_header_define.h'), 'w', encoding='utf8') as fdefine,\
        open(os.path.join(out_dir, 'ctp_td_header_process.h'), 'w', encoding='utf8') as fheaderprocess,\
        open(os.path.join(out_dir, 'ctp_td_header_on.h'), 'w', encoding='utf8') as fheaderon,\
        open(os.path.join(out_dir, 'ctp_td_header_on_orig.h'), 'w', encoding='utf8') as fheaderon_orig,\
        open(os.path.join(out_dir, 'ctp_td_header_function.h'), 'w', encoding='utf8') as fheaderfunction,\
        open(os.path.join(out_dir, 'ctp_td_wrap.cpp'), 'w', encoding='utf8') as fwrap:
