...
<[ render_data.ctp_md_header_define ]>
...
public:
	...
	<[ render_data.ctp_md_header_on_orig | indent(4) ]>
	...
	<[ render_data.ctp_md_header_process | indent(4) ]>
	...
	<[ render_data.ctp_md_header_on | indent(4) ]>
	...
	<[ render_data.ctp_md_header_function | indent(4) ]>
